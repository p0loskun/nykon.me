...
export function WorkIcon(props: IconSvgProps) {
  return (
    <BaseIcon {...props}>
      <path
...
export function BlogIcon(props: IconSvgProps) {
  return (
    <BaseIcon {...props}>
      <path
...
export function GalleryIcon(props: IconSvgProps) {
  return (
    <BaseIcon {...props}>
      <path
...
export function DiscordIcon(props: IconSvgProps) {
  return (
    <BaseIcon {...props}>
      <path
 ...
 *   <li>{@link TwitterIcon} - `twitter`</li>
...
export const Icon = ({
  ...
  height,
  ...props
}: IconSvgProps & { id: string }): ReactElement => {
